...
static const Key keys[] = {
    ...
    {Mod4Mask | Mod1Mask, XK_b, spawn,
     SHCMD("~/dwm-gruvbox/src/rofi-bluetooth")},
    {Mod4Mask | Mod1Mask, XK_n, spawn,
     SHCMD("/usr/bin/python ~/dwm-gruvbox/src/NetManagerDM")},
    {Mod4Mask | Mod1Mask, XK_c, spawn,
     SHCMD("rofi -modi 'clipboard:greenclip print' -theme "
           "'~/dwm-gruvbox/src/rofi-themes/Clipboard.rasi' -show clipboard "
           "-run-command '{cmd}'")},
    {Mod4Mask | Mod1Mask, XK_w, spawn, SHCMD("~/dwm-gruvbox/src/WallSelect")},

    /* custom  */
    {0, XF86XK_AudioMute, spawn,
     SHCMD("~/dwm-gruvbox/scripts/volume_control.sh mute")},
    {0, XF86XK_AudioLowerVolume, spawn,
     SHCMD("~/dwm-gruvbox/scripts/volume_control.sh down")},
    {0, XF86XK_AudioRaiseVolume, spawn,
     SHCMD("~/dwm-gruvbox/scripts/volume_control.sh up")},
    {0, XF86XK_MonBrightnessUp, spawn,
     SHCMD("~/dwm-gruvbox/scripts/brightness_control.sh up")},
    {0, XF86XK_MonBrightnessDown, spawn,
     SHCMD("~/dwm-gruvbox/scripts/brightness_control.sh down")},
